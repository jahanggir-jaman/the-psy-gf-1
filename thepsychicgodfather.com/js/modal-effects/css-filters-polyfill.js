    ...
    var polyfilter = {
        ...
        process_stylesheets: function () {
            ...
            window.setTimeout(function () {
                ...
                xmlHttpCheck.open('GET', window.polyfilter_scriptpath + 'libs/modal-effects/htc/sepia.htc', true);
        ...
        filters: {
            ...
            sepia: function (amount) {
                ...
                if (typeof polyfilter._ie === 'undefined') {
                    ...
                    properties['behaviorsIE'] = amount >= 0.5 ? ['url("' + polyfilter.scriptpath + 'libs/modal-effects/htc/sepia.htc")'] : [];
                }
